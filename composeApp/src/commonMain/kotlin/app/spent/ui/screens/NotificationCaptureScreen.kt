...
import app.spent.viewmodel.SettingsViewModel
...
fun NotificationCaptureScreen(onBack: () -> Unit) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                "Spent watches the payment notifications your bank, card and wallet apps post " +
            ...
            Text(
                "This is a sensitive permission — Spent only inspects notifications that look like " +
            ...
            Text(
                "Don't see the heads-up alerts? Every detected payment is also saved to your in-app " +
                    "inbox, so nothing is missed even if Spent's own notifications are turned off.",
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
        }
