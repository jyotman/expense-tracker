...
object BackupService {
    ...
    fun export(nowMillis: Long, db: SpentDatabase = Database.instance): String {
    ...
    fun restore(payload: String, db: SpentDatabase = Database.instance) {
